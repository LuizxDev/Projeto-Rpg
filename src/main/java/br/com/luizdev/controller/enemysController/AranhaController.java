...
public class AranhaController {
    ...
    public void executeRandomAttack(WarriorModel warriorModel) throws InterruptedException {
        ...
        switch (indiceAttack) {
            case 0:
                //ConsoleView.writeTerminal("A "+ aranhaModel.getName()+" apareceu repentinamente e lançou sua teia pegajosa em você! Sua vida diminuiu após o ataque.\n");
                this.attackTeiaPegajosa(warriorModel);
                break;
            case 1:
                //ConsoleView.writeTerminal("A "+ aranhaModel.getName()+" soltou um ataque venenoso em você! Sua vida diminuiu após o veneno se espalhar pelo seu corpo.\n");
